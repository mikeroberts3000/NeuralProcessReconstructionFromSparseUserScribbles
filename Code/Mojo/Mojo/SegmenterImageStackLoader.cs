...
namespace Mojo
{
    ...
    public static class SegmenterImageStackLoader
    {
        ...
        public static Dictionary<VolumeDescription> LoadDataset( SegmenterImageStackLoadDescription segmenterImageStackLoadDescription )
        {
        ...
        public static Dictionary<VolumeDescription> LoadSegmentation( SegmenterImageStackLoadDescription segmenterImageStackLoadDescription )
        {
            var volumeDescriptions = new Dictionary<VolumeDescription>();
        ...
        private static void LoadOpticalFlowForwardFiles< TEmguImageStructure, TSize >( SegmenterImageStackLoadDescription segmenterImageStackLoadDescription, string opticalFlowVolumeName, string sourceVolumeName, ref Dictionary<VolumeDescription> volumeDescriptions )
            where TEmguImageStructure : struct, IColor
            where TSize : new()
        {
            //
