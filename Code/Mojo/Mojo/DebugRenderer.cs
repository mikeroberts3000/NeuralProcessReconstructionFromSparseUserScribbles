...
namespace Mojo
{
    class DebugRenderer : IDisposable
    {
        ...
        private readonly InputLayout mRenderWireframeInputLayout;
        private readonly InputLayout mRenderSolidInputLayout;
        private readonly InputLayout mRenderTexture3DInputLayout;
        private readonly InputLayout mRenderGreyScaleTexture3DInputLayout;

        private readonly SlimDX.Direct3D11.Buffer mPositionVertexBuffer;
        private readonly SlimDX.Direct3D11.Buffer mTexCoordVertexBuffer;
