...
template < typename TCudaType >
void InitializeEdgeZMapInternal( Mojo::Core::SegmenterState* segmenterState, Mojo::Core::Dictionary< Mojo::Core::VolumeDescription >* volumeDescriptions, float minSourceValue, float maxSourceValue )
{
    ...
    MOJO_THRUST_SAFE(
        thrust::for_each(
            ...
            InitializeEdgeZMapFunction< TCudaType >(
                ...
                segmenterState->parameters.Get< float >( "EDGE_POWER_Z" ),
