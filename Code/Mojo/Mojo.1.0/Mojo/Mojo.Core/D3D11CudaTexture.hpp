...
public:
    ...
    void                      MapCudaArray();
    void                      UnmapCudaArray();
    cudaArray*                GetMappedCudaArray( int mipLevel = 0 );
    ...
    mD3D11ShaderResourceView( NULL )
{
    ...
    Thrust::Memcpy2DToArray( cudaArray, deviceVector, volumeDescription );
    UnmapCudaArray();
}
    ...
    mD3D11ShaderResourceView( NULL )
{
    ...
    MapCudaArray();
    cudaArray* cudaArray = GetMappedCudaArray();
    Thrust::Memcpy3DToArray( cudaArray, deviceVector, volumeDescription );
    UnmapCudaArray();
}
