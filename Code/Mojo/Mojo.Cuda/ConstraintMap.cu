...
extern "C" void InitializeConstraintMapFromIdMap( Mojo::Core::SegmenterState* segmenterState, int neuralProcessId )
{
    MOJO_THRUST_SAFE(
        thrust::for_each(
            ...
            InitializeConstraintMapFromIdMapFunction(
                neuralProcessId,
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_INITIALIZE_FROM_ID_MAP_DELTA_FOREGROUND" ),
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_INITIALIZE_FROM_ID_MAP_DELTA_BACKGROUND" ) ) ) );
}
...
extern "C" void InitializeConstraintMapFromIdMapForSplitting( Mojo::Core::SegmenterState* segmenterState, int neuralProcessId )
{
        ...
        MOJO_THRUST_SAFE(
            thrust::for_each(
                ...
                UpdateConstraintMapFunction(
                    ...
                    segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_SPLIT_BORDER_NEW_VALUE" ) ) ) );
    }
}
                ...
                MOJO_THRUST_SAFE(
                    thrust::for_each(
                        ...
                        InitializeConstraintMapFromPrimalMapFunction(
                            segmenterState->parameters.Get< float >( "PRIMAL_MAP_THRESHOLD" ),
                            segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_HARD_FOREGROUND_AUTO" ),
                            segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_HARD_BACKGROUND_AUTO" ) ) ) );
            }
        }
    ...
    MOJO_THRUST_SAFE(
        thrust::for_each(
            ...
            AddHardConstraintFunction(
                ...
                primalValue,
                constraintValue,
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_FALLOFF_GAUSSIAN_SIGMA" ),
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_MIN_UPDATE_THRESHOLD" ),
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_HARD_FOREGROUND_USER" ),
                segmenterState->parameters.Get< float >( "CONSTRAINT_MAP_HARD_BACKGROUND_USER" ) ) ) );
}
