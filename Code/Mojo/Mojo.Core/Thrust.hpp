...
namespace Thrust
{
    ...
    template < typename TCudaType > void Memcpy2DToArray( cudaArray* cudaArray, thrust::device_vector< TCudaType >& deviceVector, VolumeDescription volumeDescription );
    template < typename TCudaType > void Memcpy3DToArray( cudaArray* cudaArray, thrust::device_vector< TCudaType >& deviceVector, VolumeDescription volumeDescription );

    template < typename TCudaType > void Memcpy2DToArray( cudaArray* cudaArray, thrust::device_reference< TCudaType >& deviceReference, VolumeDescription volumeDescription );
    template < typename TCudaType > void Memcpy3DToArray( cudaArray* cudaArray, thrust::device_reference< TCudaType >& deviceReference, VolumeDescription volumeDescription );
    ...
    template< typename InputIterator, typename TCudaType, typename TScratchpadType > void Fill( InputIterator first, InputIterator last, TCudaType value, thrust::device_vector< TScratchpadType >& scratchpad );
...
template < typename TCudaType >
inline  void Memcpy2DToArray( cudaArray* cudaArray, thrust::device_vector< TCudaType >& deviceVector, VolumeDescription volumeDescription )
{
    ...
    MOJO_CUDA_SAFE( cudaMemcpy2DToArray( cudaArray,
                                         ...
                                         0,
                                         devicePointer,
                                         volumeDescription.numVoxels.x * sizeof( TCudaType ),
                                         volumeDescription.numVoxels.x * sizeof( TCudaType ),
                                         volumeDescription.numVoxels.y,
                                         cudaMemcpyDeviceToDevice ) );
}

template < typename TCudaType >
inline  void Memcpy3DToArray( cudaArray* cudaArray, thrust::device_vector< TCudaType >& deviceVector, VolumeDescription volumeDescription )
{
    TCudaType* devicePointer = thrust::raw_pointer_cast( &deviceVector[ 0 ] );
    ...
    pitchedPointer.pitch = volumeDescription.numVoxels.x * sizeof( TCudaType );
...
template < typename TCudaType >
inline  void Memcpy2DToArray( cudaArray* cudaArray, thrust::device_reference< TCudaType >& deviceReference, VolumeDescription volumeDescription )
{
...
template < typename TCudaType >
inline  void Memcpy3DToArray( cudaArray* cudaArray, thrust::device_reference< TCudaType >& deviceReference, VolumeDescription volumeDescription )
{
    TCudaType* devicePointer = thrust::raw_pointer_cast( &deviceReference );
...
template< typename InputIterator, typename TCudaType, typename TScratchpadType >
inline void Fill( InputIterator first, InputIterator last, TCudaType value, thrust::device_vector< TScratchpadType >& scratchpad )
{
    thrust::detail::device::cuda::use_preallocated_scratchpad           = true;
    thrust::detail::device::cuda::preallocated_scratchpad_size_in_bytes = scratchpad.size() * sizeof( TScratchpadType );
    thrust::detail::device::cuda::preallocated_scratchpad_pointer       = (void*)thrust::raw_pointer_cast( &scratchpad[ 0 ] );
